...
(function (d) {
    ...
    l.fontawesome = d.extend({}, l.bootstrap3);
    l.fontawesome.notice_icon = "fa fa-exclamation-circle";
    l.fontawesome.info_icon =
        "fa fa-info";
    l.fontawesome.success_icon = "fa fa-check";
    l.fontawesome.error_icon = "fa fa-warning";
    l.fontawesome.closer = "fa fa-times";
    l.fontawesome.pin_up = "fa fa-pause";
    l.fontawesome.pin_down = "fa fa-play";
    l.fontawesome.hi_hnd = "fa fa-chevron-down";
    var w = function () {
        v = d("body");
        k = d(window);
        k.bind("resize", function () {
            m && clearTimeout(m);
            m = setTimeout(d.pnotify_position_all, 10)
        })
    };
    document.body ? w() : d(w);
    d.extend({pnotify_remove_all: function () {
        ...
        var g, a;
        "object" != typeof e ? (a = d.extend({}, d.pnotify.defaults), a.text = e) : a = d.extend({}, d.pnotify.defaults, e);
        for (var t in a)"string" == typeof t && t.match(/^pnotify_/) && (a[t.replace(/^pnotify_/,
            "")] = a[t]);
        if (a.before_init && !1 === a.before_init(a))return null;
        var n, s = function (a, c) {
            b.css("display", "none");
            var f = document.elementFromPoint(a.clientX, a.clientY);
            b.css("display", "block");
            var e = d(f), g = e.css("cursor");
            b.css("cursor", "auto" != g ? g : "default");
            n && n.get(0) == f || (n && (r.call(n.get(0), "mouseleave", a.originalEvent), r.call(n.get(0), "mouseout", a.originalEvent)), r.call(f, "mouseenter", a.originalEvent), r.call(f, "mouseover", a.originalEvent));
            r.call(f, c, a.originalEvent);
            n = e
        }, f;
        f = "object" == typeof a.styling ?
            a.styling : l[a.styling];
        var b = d("<div />", {"class": "ui-pnotify " + a.addclass, css: {display: "none"}, mouseenter: function (p) {
            a.nonblock && p.stopPropagation();
            a.mouse_reset && "out" == g && (b.stop(!0), g = "in", b.css("height", "auto").animate({width: a.width, opacity: a.nonblock ? a.nonblock_opacity : a.opacity}, "fast"));
            a.nonblock && b.stop().animate({opacity: a.nonblock_opacity}, "fast");
            ...
            n = null;
            b.css("cursor", "auto");
            a.nonblock && "out" != g && b.stop().animate({opacity: a.opacity}, "fast");
            ...
            a.nonblock && (b.stopPropagation(), b.preventDefault(), s(b, "onmousedown"))
        }, mouseup: function (b) {
            a.nonblock && (b.stopPropagation(), b.preventDefault(), s(b, "onmouseup"))
        }, click: function (b) {
            a.nonblock && (b.stopPropagation(), s(b, "onclick"))
        }, dblclick: function (b) {
            a.nonblock && (b.stopPropagation(), s(b, "ondblclick"))
        }});
        b.opts = a;
        b.container = d("<div />", {"class": f.container + " ui-pnotify-container " + ("error" == a.type ? f.error : "info" == a.type ? f.info : "success" ==
            a.type ? f.success : f.notice)}).appendTo(b);
        ...
        b.pnotify_version = "1.2.2";
        b.pnotify = function (p) {
            var c = a;
            "string" == typeof p ? a.text = p : a = d.extend({}, a, p);
            ...
            a.shadow != c.shadow && (a.shadow ?
                b.container.addClass("ui-pnotify-shadow") : b.container.removeClass("ui-pnotify-shadow"));
            ...
            !1 === a.text ? b.text_container.slideUp("fast") : a.text !== c.text && (a.text_escape ? b.text_container.text(a.text).slideDown(200) :
            ...
            if (a.icon !== c.icon || !0 === a.icon && a.type != c.type)b.container.find("div.ui-pnotify-icon").remove(), !1 !== a.icon && d("<div />", {"class": "ui-pnotify-icon"}).append(d("<span />", {"class": !0 ===
                a.icon ? "error" == a.type ? f.error_icon : "info" == a.type ? f.info_icon : "success" == a.type ? f.success_icon : f.notice_icon : a.icon})).prependTo(b.container);
            a.width !== c.width && b.animate({width: a.width});
            a.min_height !== c.min_height && b.container.animate({minHeight: a.min_height});
        ...
        b.pnotify_position = function (a) {
            ...
            if (c) {
                ...
                if (!d || a) {
                    ...
                    if ("down" == c.dir1 && c.nextpos1 +
                        b.height() > k.height() || "up" == c.dir1 && c.nextpos1 + b.height() > k.height() || "left" == c.dir1 && c.nextpos1 + b.width() > k.width() || "right" == c.dir1 && c.nextpos1 + b.width() > k.width())c.nextpos1 = c.firstpos1, c.nextpos2 += c.addpos2 + ("undefined" == typeof c.spacing2 ? 25 : c.spacing2), c.addpos2 = 0;
                    ...
                    } else c.nextpos2 && b.css(h, c.nextpos2 +
                        "px");
                    switch (c.dir2) {
                        case "down":
                        case "up":
                    ...
                    (e.top || e.bottom || e.right || e.left) && b.animate(e,
                        {duration: this.opts.position_animate_speed, queue: !1});
                    switch (c.dir1) {
                        case "down":
                        case "up":
        ...
        b.pnotify_queue_position = function (a) {
            m && clearTimeout(m);
            a || (a = 10);
            m = setTimeout(d.pnotify_position_all, a)
        };
        ...
        b.pnotify_remove = function (d) {
            ...
            a.before_close && !1 === a.before_close(b,
                d) || b.animate_out(function () {
                a.after_close && !1 === a.after_close(b, d) || (b.pnotify_queue_position(), a.remove && b.detach())
            })
        };
        ...
        b.animate_out = function (d) {
            ...
            "none" == c ? (b.hide(), d()) : "show" == c ? b.hide(a.animate_speed, d) : "fade" == c ? b.fadeOut(a.animate_speed, d) : "slide" == c ? b.slideUp(a.animate_speed, d) : "function" == typeof c ? c("out", d, b) : b.hide(c, "object" == typeof a.animation.options_out ? a.animation.options_out : {}, a.animate_speed, d)
        };
        b.pnotify_cancel_remove = function () {
            b.timer && window.clearTimeout(b.timer)
        };
        b.pnotify_queue_remove =
            function () {
        ...
        b.closer = d("<div />", {"class": "ui-pnotify-closer", css: {cursor: "pointer", visibility: a.closer_hover ? "hidden" : "visible"}, click: function () {
            b.pnotify_remove(!1);
            b.sticker.css("visibility", "hidden");
            b.closer.css("visibility", "hidden")
        }}).append(d("<span />", {"class": f.closer, title: a.labels.close})).appendTo(b.container);
        a.closer && !a.nonblock || b.closer.css("display", "none");
        b.sticker =
            d("<div />", {"class": "ui-pnotify-sticker", css: {cursor: "pointer", visibility: a.sticker_hover ? "hidden" : "visible"}, click: function () {
                a.hide = !a.hide;
            ...
            }).append(d("<span />", {"class": f.pin_up, title: a.labels.stick})).appendTo(b.container);
        a.sticker && !a.nonblock || b.sticker.css("display", "none");
        !1 !== a.icon && d("<div />", {"class": "ui-pnotify-icon"}).append(d("<span />", {"class": !0 === a.icon ? "error" == a.type ? f.error_icon : "info" == a.type ? f.info_icon : "success" == a.type ? f.success_icon : f.notice_icon : a.icon})).prependTo(b.container);
        b.title_container = d("<h4 />", {"class": "ui-pnotify-title"}).appendTo(b.container);
        !1 === a.title ? b.title_container.hide() : a.title_escape ? b.title_container.text(a.title) : b.title_container.html(a.title);
        b.text_container = d("<div />", {"class": "ui-pnotify-text"}).appendTo(b.container);
        ...
        if (a.history) {
            var q = k.data("pnotify_history");
            "undefined" == typeof q && (q = d("<div />", {"class": "ui-pnotify-history-container " + f.hi_menu, mouseleave: function () {
                q.animate({top: "-" + u + "px"}, {duration: 100, queue: !1})
            }}).append(d("<div />", {"class": "ui-pnotify-history-header", text: a.labels.redisplay})).append(d("<button />", {"class": "ui-pnotify-history-all " + f.hi_btn, text: a.labels.all, mouseenter: function () {
                ...
                click: function () {
                    ...
                    return!1
                }})).append(d("<button />", {"class": "ui-pnotify-history-last " + f.hi_btn, text: a.labels.last, mouseenter: function () {
                d(this).addClass(f.hi_btnhov)
            }, mouseleave: function () {
                d(this).removeClass(f.hi_btnhov)
            }, click: function () {
                ...
                return!1
            }})).appendTo(v), u = d("<span />", {"class": "ui-pnotify-history-pulldown " + f.hi_hnd, mouseenter: function () {
                q.animate({top: "0"}, {duration: 100, queue: !1})
            }}).appendTo(q).offset().top + 2, q.css({top: "-" + u + "px"}), k.data("pnotify_history", q))
        }
        a.stack.animation = !1;
        a.auto_display && b.pnotify_display();
        return b
    }});
